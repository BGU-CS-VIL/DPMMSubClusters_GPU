...
void data_generators::generate_gaussian_data(PointType N, DimensionsType D, BaseType K, double MixtureVar, MatrixXd& x,
...
void data_generators::generate_mnmm_data(PointType N, DimensionsType D, BaseType K, BaseType trials,
	MatrixXd& x,
	LabelsType& labels,
	MatrixXd& clusters)
{
